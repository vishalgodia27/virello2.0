...
import { Wallet, CircleDollarSign, Banknote, Gem, Check } from "lucide-react";

export const SelectBudgetList = [
  {
    id: 1,
    title: "Budget",
    desc: "Backpacker friendly, keeping costs low without missing the fun.",
    icon: Wallet,
    price: "₹1000–₹5000",
  ...
  },
  {
    id: 2,
    title: "Moderate",
    desc: "A balanced trip with comfortable stays and good experiences.",
  ...
  },
  {
    id: 3,
    title: "Luxury",
    desc: "Premium stays, fine dining, and top-tier experiences.",
    icon: Gem,
    price: "₹15,000–₹50,000",
  ...
  },
  {
    id: 4,
    title: "Ultra Luxury",
    desc: "No limits — the finest hotels, private tours, and exclusivity.",
    icon: Banknote,
    price: "₹50,000+",
...
function BudgetUi({
  ...
  onSelect?: (item: (typeof SelectBudgetList)[number]) => void;
}) {
  const [selected, setSelected] = useState<number | null>(null);

  const handleSelect = (item: (typeof SelectBudgetList)[number]) => {
    setSelected(item.id);
    onSelect?.(item);
  };
