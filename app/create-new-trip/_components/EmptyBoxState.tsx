...
// <h2 className='font-bold  text-xl  text align-center'>Start Planning <strong className=''> new trip using ai</strong> </h2>
// <div className="flex flex-col w-full max-w-5xl items-stretch justify-center gap-6">
